...
use Checnes\RegistroBundle\Entity\Empresa;
...
class EmpresaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $empresas = $em->getRepository('ChecnesRegistroBundle:Empresa')->findAll();
    ...
    {
        $empresa = new Empresa();
        $form = $this->createForm('Checnes\RegistroBundle\Form\EmpresaType', $empresa);
